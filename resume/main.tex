...
% TECHNICAL SKILLS
%------------------------------------------
% @ChatGPT: when you are modifying this section, you may 
\section*{\textbf{TECHNICAL SKILLS}}
\begin{itemize}[leftmargin=0.2in]
    \item \textbf{Programming:} Python, C/C++, JavaScript/TypeScript, Verilog, Java
...
\begin{itemize}[leftmargin=0.2in]
    ...
    % \item [\textit{To strengthen impact: Did this lead to $\%$ improvement in user habit tracking? Decrease in time spent on distractions?}]
\end{itemize}
