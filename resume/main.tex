...
\noindent\href{https://github.com/Ken-2511/UWB-Summer-Research}{\uline{
\textbf{Research Assistant, Ultra-Wideband Communication Systems (University of Toronto)}}} \hfill Jun 2025 - Jul 2025
\begin{itemize}[leftmargin=0.2in]
    \item Developed hybrid modulation techniques combining 2PPM and 8PSK for UWB communication systems, achieving 500Mbps symbol rate at 4GHz carrier frequency with 20dB SNR performance.
    \item Implemented complete signal processing pipeline using MATLAB Simulink and Python, including phase noise modeling, AWGN addition, and multi-stage sampling rate conversion (16GHz → 1024GHz).
    \item Designed innovative demodulation algorithms using K-means clustering for automatic constellation calibration and template matching for precise pulse position detection.
    \item Achieved sub-150$\mu$s measurement precision through advanced edge detection algorithms and dynamic offset correction, processing terahertz-scale sampling data (1.024THz) for high-resolution signal analysis.
    \item Conducted comprehensive BER analysis and performance evaluation, generating 50MB+ of simulation data and establishing ground truth datasets for future UWB research.
\end{itemize}
...
\begin{itemize}[leftmargin=0.2in]
    \item Designed and built 10 laser-based speed measurement units with nixie tube displays for high school physics education.
